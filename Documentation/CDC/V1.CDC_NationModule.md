...
### Formule de pondération (proposée, à valider)
...
> ⚠️ **Déséquilibre détecté à vérifier** : avec cette pondération, le facteur réputation (distance au neutre × 3, jusqu'à 700 de distance possible côté Légendaire) domine largement tous les autres facteurs combinés — une Nation extrême (Infâme ou Légendaire) obtient 4 à 5 fois plus de Puissance qu'une Nation neutre, indépendamment de ses guerres/recherche/artefacts. Il y a aussi une asymétrie : la distance maximale au neutre n'est pas la même côté Infâme (500) que côté Légendaire (700), avantageant mécaniquement les Nations très vertueuses. **Multiplicateur réputation à revoir avant calibrage final** (proposition : ×0.5 ou ×1 au lieu de ×3, ou normaliser la distance sur une échelle 0-100).
