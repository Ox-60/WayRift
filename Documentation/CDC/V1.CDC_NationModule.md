...
- **FactionModule** — palier précédent (Organisation), condition de transition
- **Gameplay Layers** — pilier de design justifiant le fonctionnement séparé des Nations
- **Recherche_Faction (V5)** — système de progression exclusif aux Nations
- **Entreprises** — item unique et flux B2B partagés avec le FactionModule
