...
- **ReputationModule** — le prestige et les sanctions affectent la réputation
- **PlayerModule** — coffre Objets Perdus, mécaniques de wipe partagées
- **Tebex** — tokens utilisés pour le wipe prestige
