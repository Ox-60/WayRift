...
|---|---|---|
| `/ah sell <prix>` | Met en vente l'item tenu en main | joueur (réputation ≥ 200) |
| `/ah list` | Ouvre l'interface des offres disponibles à l'achat | joueur (réputation ≥ 200) |
| `/ah buy <id>` | Achète directement une offre listée | joueur (réputation ≥ 200) |
| `/ah my` | Affiche mes propres annonces en cours | joueur |
| `/ah cancel <id>` | Retire une de mes annonces avant expiration | joueur |
| `/ah collect` | Récupère l'argent des ventes conclues / items expirés (Ender Chest) | joueur |
| `/ah history` | Historique de mes transactions (achats/ventes) | joueur |
| `/ah stats <item>` | Affiche le prix moyen sur 30 jours pour un item | joueur |
