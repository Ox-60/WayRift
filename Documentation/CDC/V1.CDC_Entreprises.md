...
|---|---|---|
| `/e admin create <organisation> <nom>` | Crée un nouvel item unique, ouvre l'éditeur de recette et de prix initial | GM |
| `/e admin setprice <item> <prix>` | Définit le prix constructeur initial de l'item | GM |
| `/e admin setrecipe <item>` | Ouvre l'éditeur de recette (ressources + quantités) | GM |
| `/e admin editprice <item> <prix>` | Modifie le prix initial d'un item existant (rééquilibrage) | GM |

### Commande chef — Ajustement du prix

| Commande | Description | Permission |
|---|---|---|
| `/e setprice <item> <prix>` | Ajuste le prix constructeur dans la fourchette autorisée | chef |
