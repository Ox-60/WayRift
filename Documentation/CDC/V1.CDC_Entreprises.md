...
| Fourchette d'ajustement chef | Autour du prix initial GM — pourcentage exact à définir (point ouvert) |
...
| # | Point | Priorité |
|---|---|---|
| 1 | Limite nombre de contrats actifs simultanés | Faible (S4+) |
| 2 | Interface logs — GUI ou commande `/e logs` ? | Faible (S4+) |
