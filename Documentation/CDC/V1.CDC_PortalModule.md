...
|---|---|---|---|
| `/wtp <monde>` | TP direct vers le spawn d'un monde | GM/staff | `wayrift.portal.admin.tp` |
| `/capital` | TP direct vers la Capitale | GM/staff | `wayrift.portal.tp.capital` |
| `/portal link <a> <b>` | Crée le lien entre deux portails stables | admin | `wayrift.portal.admin.link` |
| `/portal ban <uuid> <monde>` | Bannit un joueur d'un monde | admin | `wayrift.portal.admin.ban` |
| `/portal faille create <joueur>` | Crée une faille pour un joueur sans item (GM event) | GM | `wayrift.portal.admin.faille` |
...
- **WorldModule** — dépend des mondes déclarés pour créer les liaisons de portails
- **PlayerModule** — gestion de l'arrivée en Down/Coma à travers un portail
