...
**Prix d'un claim** : à définir (point ouvert) — probablement calibré en semaines de farm modéré, comme les autres prix économiques du serveur.
...
> Proposition à valider — durée de capture (X temps) et modalités exactes à définir.
