...
- **Puissance** : combien la faction pèse militairement (via événements/guerres). **Purement cosmétique** — affichée dans le classement `/f top`, aucun effet mécanique sur le jeu (ne détermine plus les claims depuis la refonte du système d'achat lié à la taille du groupe).
