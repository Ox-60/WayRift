...
**Prix d'un claim — croissance exponentielle, de 5% à 20% du revenu hebdomadaire.**

```
Prix du n-ième claim = 5% × r^(n-1), plafonné à 20%
Où r est calibré pour atteindre exactement 20% au dernier claim
autorisé pour la plus grande faction (Organisation avancée, 25 claims)
r ≈ 1.0595 (~5.95% de hausse par claim)

Exemples :
  Claim #1  : 5.0% du revenu hebdo
  Claim #5  : 6.3%
  Claim #10 : 8.4%
  Claim #15 : 11.2%
  Claim #20 : 15.0%
  Claim #25 : 20.0% (plafond)
```

> Chaque nouveau claim coûte plus cher que le précédent — les premiers claims restent accessibles, l'expansion territoriale massive devient un vrai investissement. Le pourcentage s'applique au revenu hebdomadaire de la faction au moment de l'achat (comme les places Nation supplémentaires).
